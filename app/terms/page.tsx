      ...
      <header className="border-b border-border/40 bg-background/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="font-black text-lg md:text-xl tracking-tighter italic uppercase">FocusStudy</span>
          </Link>
          <Button variant="ghost" asChild className="font-bold uppercase italic text-[10px] md:text-xs tracking-widest h-9 md:h-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-6 mb-8 md:mb-12 border-b border-border/40 pb-6 md:pb-8">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 mb-3 md:mb-4">
              ...
              <span className="text-[8px] md:text-[10px] font-black uppercase tracking-widest text-primary">Documento Jurídico</span>
            </div>
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 md:space-y-12">
          ...
          <section className="bg-card/50 p-6 md:p-8 rounded-3xl md:rounded-4xl border border-border/40">
            <h2 className="text-lg md:text-xl font-black uppercase italic mb-3 md:mb-4 flex items-center gap-2">
              <ShieldCheck className="text-primary h-4 w-4 md:h-5 md:w-5" /> 1. Aceitação do Contrato
            </h2>
          ...
          <section className="space-y-4 md:space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-3 md:pl-4">2. Planos, Pagamentos e Renovação</h2>
            <div className="grid gap-4 md:gap-6">
              <div className="space-y-1">
                <h3 className="font-bold text-foreground uppercase italic text-[11px] md:text-sm">2.1. Natureza da Assinatura</h3>
              ...
              <div className="space-y-1">
                <h3 className="font-bold text-foreground uppercase italic text-[11px] md:text-sm">2.2. Renovação Automática</h3>
                <p className="text-muted-foreground text-xs md:text-sm italic leading-relaxed">
              ...
              <div className="space-y-1">
                <h3 className="font-bold text-foreground uppercase italic text-[11px] md:text-sm">2.3. Direito de Arrependimento</h3>
                <p className="text-muted-foreground text-xs md:text-sm italic leading-relaxed">
          ...
          <section className="space-y-4 md:space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-3 md:pl-4">3. Teste Gratuito (Trial)</h2>
            <p className="text-muted-foreground text-xs md:text-sm leading-relaxed italic">
          ...
          <section className="space-y-4 md:space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-3 md:pl-4">4. Inteligência Artificial e Limitações</h2>
            <p className="text-muted-foreground text-xs md:text-sm leading-relaxed italic">
          ...
          <section className="space-y-4 md:space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-3 md:pl-4">5. Propriedade Intelectual</h2>
            <p className="text-muted-foreground text-xs md:text-sm leading-relaxed italic">
          ...
          <section className="space-y-4 md:space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-3 md:pl-4">6. Limitação de Responsabilidade</h2>
          ...
          <section className="space-y-4 md:space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-3 md:pl-4">7. Foro e Legislação</h2>
            <p className="text-muted-foreground text-xs md:text-sm leading-relaxed italic">
