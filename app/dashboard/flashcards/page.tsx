                ...
                <>
                  ...
                  <div className="p-4 md:p-6 bg-muted/20 border-t mt-auto">
                    <Button 
                      ...
                      className={`w-full h-14 md:h-16 text-sm md:text-lg font-black uppercase transition-all shadow-xl cursor-pointer ${
                        isSaved ? "bg-green-500 hover:bg-green-500" : "bg-green-600 hover:bg-green-700"
                      }`}
                    >
                      {isSaving ? (
