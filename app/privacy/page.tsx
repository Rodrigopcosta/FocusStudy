      ...
      <main className="container mx-auto px-4 py-8 md:py-16 max-w-4xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-10 md:space-y-12">
          ...
          <section className="space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-4">2. Coleta de Dados e Finalidade</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-4">3. Compartilhamento com Terceiros</h2>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <section className="space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-4">4. Seus Direitos (Art. 18 LGPD)</h2>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <section className="space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-4">5. Segurança e Criptografia</h2>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <section className="space-y-6">
            <h2 className="text-lg md:text-xl font-black uppercase italic border-l-4 border-primary pl-4">6. Retenção de Dados</h2>
            <p className="text-muted-foreground text-sm leading-relaxed">
